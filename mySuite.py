...
class MySuite(ctk.CTk):
    def __init__(self):
        ...
        self.button1 = ctk.CTkButton(master=self, text="Login", command=self.login)
        self.button1.grid(row=0, column=0, pady=10, padx=10, sticky="nesw")

        self.button2 = ctk.CTkButton(master=self, text="Login", command=self.login)
        self.button2.grid(row=0, column=1, pady=10, padx=10, sticky="nesw")

        self.button3 = ctk.CTkButton(master=self, text="Login", command=self.login)
        self.button3.grid(row=0, column=2, pady=10, padx=10, sticky="nesw")

        self.button4 = ctk.CTkButton(master=self, text="Login", command=self.login)
        self.button4.grid(row=1, column=0, pady=10, padx=10, sticky="nesw")

        self.button5 = ctk.CTkButton(master=self, text="Login", command=self.login)
        self.button5.grid(row=1, column=1, pady=10, padx=10, sticky="nesw")

        self.button6 = ctk.CTkButton(master=self, text="Login", command=self.login)
...
# # class App(customtkinter.CTk):# [[Below commented code is a sample provided by customtkinter, not my own work]]
# #     def __init__(self):
# #         super().__init__()
